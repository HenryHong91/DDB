...
export const EditorData = () => (
  <div>
    <h3>Important : prepare summer holiday !</h3>
  </div>
);
...
const areaChartData = [
  ...
  [
    ...
    { x: new Date(2023, 0, 1), y: 2.8 },
    { x: new Date(2024, 0, 1), y: 1.5 },
  ],
  [
    ...
    { x: new Date(2023, 0, 1), y: 2.7 },
    { x: new Date(2024, 0, 1), y: 1.1 },
  ],
  [
    { x: new Date(2015, 0, 1), y: 0.8 },
    { x: new Date(2016, 0, 1), y: 1.15 },
    { x: new Date(2018, 0, 1), y: 1.8 },
    { x: new Date(2019, 0, 1), y: 1.9 },
    { x: new Date(2020, 0, 1), y: 3 },
    { x: new Date(2021, 0, 1), y: 1.2 },
    { x: new Date(2022, 0, 1), y: 2.8 },
    { x: new Date(2023, 0, 1), y: 1.7 },
    { x: new Date(2024, 0, 1), y: 1.5 },
  ],
];
...
export const lineChartData = [
  [
    ...
    { x: new Date(2018, 0, 1), y: 13 },
    { x: new Date(2019, 0, 1), y: 14 },
    { x: new Date(2020, 0, 1), y: 13 },
    { x: new Date(2021, 0, 1), y: 9 },
  ...
  [
    ...
    { x: new Date(2023, 0, 1), y: 60 },
  ],

  [
    { x: new Date(2017, 0, 1), y: 60 },
    { x: new Date(2018, 0, 1), y: 70 },
    { x: new Date(2019, 0, 1), y: 60 },
    { x: new Date(2020, 0, 1), y: 59 },
    { x: new Date(2021, 0, 1), y: 45 },
...
export const pieChartData = [
  { x: "New Zealand", y: 18, text: "18%" },
  { x: "South Korea", y: 8, text: "8%" },
  { x: "Australia", y: 15, text: "15%" },
  { x: "Fiji", y: 11, text: "11%" },
  { x: "China", y: 18, text: "18%" },
  { x: "Japan", y: 14, text: "14%" },
  { x: "USA", y: 16, text: "16%" },
];
