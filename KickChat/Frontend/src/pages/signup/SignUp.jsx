    ...
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
      <div className="w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Link
            to={"/login"}
            className="text-sm text-center w-full hover:underline hover:text-blue-600 mt-2 inline-block"
            href="#"
          >
          ...
          <div>
            <button
              className="btn btn-block btn-sm mt-2 border hover:bg-fuchsia-700 hover:text-white"
              disabled={loading}
            >
              {loading ? (
